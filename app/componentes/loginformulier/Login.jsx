  ...
  return (
    <div className="loginForm">
      <div className="loginFormContent">
        <h2
          className={
            "animateLoginForm " + (isRegistering ? "hideLogin" : "showLogin")
          }
          style={
            !isRegistering
              ? { animationDelay: `${getDelay()}s` }
              : { animationDelay: `${getDelaybySchakelen()}s` }
          }
        >
          - LOGIN -
        </h2>
        ...
        <div
          className={
            "divider animateLoginForm " +
            (isRegistering ? "hideLogin" : "showLogin")
          }
          style={
            !isRegistering
              ? { animationDelay: `${getDelay()}s` }
